...
\colorlet{basecolor}{teal}
\colorlet{akzentcolor}{mint}

%Siehe hierzu preamble.sty
\renewcommand{\theauthor}{\textfb{Team-07:} Laura Dankers, Danielle Matcheu, Luis Patzewitz, Freyr Rehmke, Marcel Stiller, Janet Strelow, Joliesse Ludivine Magne Tuekam}
\renewcommand{\thetitle}{Navis pessundantur}
\renewcommand{\thesubtitle}{Die Webanwendung von Team 07}
